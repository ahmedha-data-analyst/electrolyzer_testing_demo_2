...
DARK_THEME = {
    ...
    "utility_icon": "#d7dde2",
    "utility_hover_bg": "rgba(167,215,48,0.10)",
    "utility_hover_border": "rgba(167,215,48,0.68)",
    "utility_hover_icon": "#bfe35f",
    "focus_ring": "#A7D730",
    "dialog_bg": "#171d22",
...
.crit-top { display:flex; align-items:center; justify-content:space-between; gap:.32rem;
    margin-bottom:.22rem; padding-right:2.4rem; }
...
.crit-meta { margin-top:.4rem; display:flex; align-items:center; gap:.4rem; flex-wrap:wrap;
    color:${subtext} !important; font-size:.7rem; }
...
[class*="st-key-pid_help_"] {
    position:absolute; top:.46rem; right:.5rem; z-index:4;
